...
import com.example.bthea.htttsvtdt.fragments.KetQuaFragment;
import com.example.bthea.htttsvtdt.fragments.QuaTrinhFragment;
...
public class HdqtActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new QuaTrinhFragment(), "Quá trình");
        adapter.addFrag(new KetQuaFragment(), "Kết quả");
